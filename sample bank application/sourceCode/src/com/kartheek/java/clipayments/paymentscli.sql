...
Show Databases;
use Paymentapp;
create table User(UserId int NOT NULL, FirstName varchar(25),LastName varchar(25),Phoneno int, DateofBirth varchar(25),Address varchar(100),PassWord varchar(25),Wallet int, 
primary key(UserId));
show tables;
Select * from user;
drop table user;
